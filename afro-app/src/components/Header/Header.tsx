...
export default function Header(){
    return(
        <>
            <div className="flex flex-row items-center Header-top-part">
            ...
            <div className="flex flex-row Header-bottom-part gap-5">
                <div className="flex basis-3/4">
                    <div className="flex flex-row basis-1/5">
                        <span className="">رزرو استخر و پارک آبی</span>

                    </div>
                    <div className="flex flex-row basis-1/5">
                        <span>رزرو سلامتکده</span>
                        <span>
                    ...
                    <div className="flex flex-row basis-1/5">
                        ...
                        <span>مجموعه ها روی نقشه</span>
                    </div>
                </div>
                <div className="flex basis-1/4 justify-end gap-6">
                    <div className="flex justify-end">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
